...
--
-- Máy chủ: 127.0.0.1
-- Thời gian đã tạo: Th12 28, 2018 lúc 10:46 AM
...
(4, 'SendMail', 'SendMail', 'app\\modules\\email\\commands\\SendMail', 'email', 0x7b226d696e75746573223a5b222d31225d2c22686f757273223a5b222d31225d2c226461795f74797065223a22646f77222c22646f77223a5b222d31225d7d, 1545990311, 1545990371, 1, 1);
...
('SendMail', 1545900011, 'Success.'),
('SendMail', 1545900311, 'Success.'),
('SendMail', 1545900611, 'Success.'),
('SendMail', 1545900911, 'Success.'),
('SendMail', 1545901211, 'Success.'),
('SendMail', 1545901511, 'Success.'),
('SendMail', 1545901811, 'Success.'),
('SendMail', 1545902111, 'Success.'),
('SendMail', 1545902411, 'Success.'),
('SendMail', 1545902711, 'Success.'),
('SendMail', 1545903011, 'Success.'),
('SendMail', 1545903311, 'Success.'),
('SendMail', 1545903611, 'Success.'),
('SendMail', 1545903911, 'Success.'),
('SendMail', 1545904211, 'Success.'),
('SendMail', 1545904511, 'Success.'),
('SendMail', 1545904811, 'Success.'),
('SendMail', 1545905111, 'Success.'),
('SendMail', 1545905411, 'Success.'),
('SendMail', 1545905711, 'Success.'),
('SendMail', 1545906011, 'Success.'),
('SendMail', 1545961222, 'Success.'),
('SendMail', 1545961511, 'Success.'),
('SendMail', 1545961812, 'Success.'),
('SendMail', 1545962111, 'Success.'),
('SendMail', 1545962411, 'Success.'),
('SendMail', 1545962711, 'Success.'),
('SendMail', 1545963011, 'Success.'),
('SendMail', 1545963311, 'Success.'),
('SendMail', 1545963611, 'Success.'),
('SendMail', 1545963911, 'Success.'),
('SendMail', 1545964211, 'Success.'),
('SendMail', 1545964511, 'Success.'),
('SendMail', 1545964811, 'Success.'),
('SendMail', 1545965111, 'Success.'),
('SendMail', 1545965411, 'Success.'),
('SendMail', 1545965711, 'Success.'),
('SendMail', 1545966011, 'Success.'),
('SendMail', 1545966311, 'Success.'),
('SendMail', 1545966611, 'Success.'),
('SendMail', 1545966911, 'Success.'),
('SendMail', 1545967211, 'Success.'),
('SendMail', 1545967511, 'Success.'),
('SendMail', 1545967811, 'Success.'),
('SendMail', 1545968111, 'Success.'),
('SendMail', 1545968411, 'Success.'),
('SendMail', 1545968711, 'Success.'),
('SendMail', 1545969011, 'Success.'),
('SendMail', 1545969311, 'Success.'),
('SendMail', 1545969611, 'Success.'),
('SendMail', 1545969911, 'Success.'),
('SendMail', 1545970211, 'Success.'),
('SendMail', 1545970511, 'Success.'),
('SendMail', 1545970810, 'Success.'),
('SendMail', 1545971111, 'Success.'),
('SendMail', 1545971411, 'Success.'),
('SendMail', 1545971711, 'Success.'),
('SendMail', 1545972011, 'Success.'),
('SendMail', 1545972311, 'Success.'),
('SendMail', 1545972611, 'Success.'),
('SendMail', 1545972911, 'Success.'),
('SendMail', 1545973211, 'Success.'),
('SendMail', 1545973511, 'Success.'),
('SendMail', 1545973811, 'Success.'),
('SendMail', 1545974111, 'Success.'),
('SendMail', 1545974411, 'Success.'),
('SendMail', 1545974711, 'Success.'),
('SendMail', 1545975011, 'Success.'),
('SendMail', 1545975311, 'Success.'),
('SendMail', 1545975611, 'Success.'),
('SendMail', 1545975911, 'Success.'),
('SendMail', 1545976211, 'Success.'),
('SendMail', 1545976511, 'Success.'),
('SendMail', 1545976811, 'Success.'),
('SendMail', 1545977111, 'Success.'),
('SendMail', 1545977411, 'Success.'),
('SendMail', 1545977711, 'Success.'),
('SendMail', 1545978011, 'Success.'),
('SendMail', 1545978311, 'Success.'),
('SendMail', 1545978611, 'Success.'),
('SendMail', 1545978911, 'Success.'),
('SendMail', 1545979211, 'Success.'),
('SendMail', 1545979511, 'Success.'),
('SendMail', 1545979811, 'Success.'),
('SendMail', 1545980111, 'Success.'),
('SendMail', 1545980411, 'Success.'),
('SendMail', 1545980711, 'Success.'),
('SendMail', 1545981011, 'Success.'),
('SendMail', 1545981311, 'Success.'),
('SendMail', 1545981611, 'Success.'),
('SendMail', 1545981911, 'Success.'),
('SendMail', 1545982211, 'Success.'),
('SendMail', 1545982511, 'Success.'),
('SendMail', 1545982812, 'Success.'),
('SendMail', 1545983111, 'Success.'),
('SendMail', 1545983411, 'Success.'),
('SendMail', 1545983711, 'Success.'),
('SendMail', 1545984011, 'Success.'),
('SendMail', 1545984311, 'Success.'),
('SendMail', 1545984611, 'Success.'),
('SendMail', 1545984911, 'Success.'),
('SendMail', 1545985211, 'Success.'),
('SendMail', 1545985511, 'Success.'),
('SendMail', 1545985811, 'Success.'),
('SendMail', 1545986111, 'Success.'),
('SendMail', 1545986411, 'Success.'),
('SendMail', 1545986711, 'Success.'),
('SendMail', 1545987011, 'Success.'),
('SendMail', 1545987311, 'Success.'),
('SendMail', 1545987611, 'Success.'),
('SendMail', 1545987911, 'Success.'),
('SendMail', 1545988211, 'Success.'),
('SendMail', 1545988511, 'Success.'),
('SendMail', 1545988811, 'Success.'),
('SendMail', 1545989111, 'Success.'),
('SendMail', 1545989411, 'Success.'),
('SendMail', 1545989711, 'Success.'),
('SendMail', 1545990011, 'Success.'),
('SendMail', 1545990311, 'Success.');
...
(11, 'api1', '', 'api1@gmail.com', '', 'api1', 1, 0, 1545895247, 4, 1545904314);
